 ...
 *
 * @author: pookie13
 * @url: https://github.com/pookie13/ZoomImage
 *
 */
...
public class TouchImageView extends ImageView {
    ...
    private void drawGuidelines(@NonNull Canvas canvas) {
        ...
        final float x1 = getLeft() + oneThirdCropWidth;
        canvas.drawLine(x1, getTop(), x1, getBottom(), mGuidelinePaint);
        final float x2 = getRight() - oneThirdCropWidth;
        canvas.drawLine(x2, getTop(), x2, getBottom(), mGuidelinePaint);

        final float oneThirdCropHeight = getHeight() / 3;
        final float y1 = getTop() + oneThirdCropHeight;
        canvas.drawLine(getLeft(), y1, getRight(), y1, mGuidelinePaint);
        final float y2 = getBottom() - oneThirdCropHeight;
        canvas.drawLine(getLeft(), y2, getRight(), y2, mGuidelinePaint);
    }
